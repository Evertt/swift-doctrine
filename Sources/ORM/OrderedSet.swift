...
//struct OS<T: Hashable> {
//    typealias Index = Dictionary<T,Int>.Index
//
//    var contents = [T:Int]()
...
//    }
//
//    mutating func append(_ newMember: T) {
//        guard contents[newMember] == nil else {
//            return
//        }
//
//        let count = self.count
//        contents[newMember] = count
//        indices[count] = contents.index(forKey: newMember)
//    }
//
//    mutating func remove(_ member: T) -> T? {
//        return contents.removeValue(forKey: member).map {
//            index in indices.removeValue(forKey: index)
//        }.map { member }
//    }
//
//    mutating func insert(_ newMember: T, at index: Int) {
//        if let oldIndex = contents[newMember] {
//
//        } else {
//            contents[newMember] = index
//
